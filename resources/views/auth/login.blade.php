        ...
        <div class="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-tr from-emerald-500 to-emerald-200">
            ...
            <form action="{{route('login')}}" method="POST" class="zoom-in flex flex-col rounded-3xl bg-white p-8 w-full sm:w-[420px]">
                ...
                <div class="flex justify-center">
                    <h1 class="text-center text-2xl">Ti diamo il benvenuto!</h1>
                </div>
                ...
                <div class="text-center mb-8">
                    <button type="submit" class="bg-emerald-400 py-2 px-10 rounded-full hover:bg-emerald-200 transition-all">Accesso al Mercato Facile</button>
                </div>

                <div class="text-center">
                    <h2>Non hai un account? <a href="{{route('register')}}" class="text-emerald-500">Registrati</a></h2>
                </div>
            </form>
